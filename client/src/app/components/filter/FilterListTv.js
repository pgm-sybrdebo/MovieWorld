...
const GENRES = ['action', 'animation', 'comedy', 'crime', 'documentary', 'drama', 'family', 'kids', 'mystery', 'news', 'reality', 'sciencefiction', 'soap', 'talk', 'politics', 'western']
...
const FilterListTv = ( { open, onOpenChange, onFilterChange } ) => {
